    ...
    execute: function () {
      ...
      _export("TGameDataClass", TGameDataClass = class TGameDataClass {
        ...
        getUserInfoCoinAtLocalStorate() {
          var myCoin = parseInt(localStorage.getItem(this.USER_COIN_KEY));
        ...
        getDailyPromotionAtLocalStorate() {
          var dateString = localStorage.getItem(this.DAILY_PROMOTION_KEY);
        ...
        setDailyPromotionAtLocalStorate() {
          ...
          var dateString = year + "-" + month + "-" + day; // console.log(dateString); // 예: "2023-06-06"
        ...
        getWatchVideoCoinTime(index) {
          var key = 'watch_video_coin_time_' + index.toString();
          var watchVideoCoinTime = localStorage.getItem(key);
          var watchVideoCoinTimeRemain = 0;
