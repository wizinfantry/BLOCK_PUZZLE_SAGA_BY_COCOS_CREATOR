    ...
    execute: function () {
      ...
      _export("TMainSceneClass", TMainSceneClass = (_dec = ccclass("mainSceneClass"), _dec(_class = class TMainSceneClass extends (_crd && TSceneClass === void 0 ? (_reportPossibleCrUseOfTSceneClass({
        ...
        addMyGameItem(myGame) {
          let gameItem = instantiate(this.gameItemPrefab); // gameImageSprite  게임 이미지
          // should_hide_in_hierarchy/fabGameItem/mainNode/gameInfoNode1/gameImage/gameImageSprite
        ...
        initAddGameItem() {
          this.owner.gameData.addGameList.forEach((addGame, index) => {
            let addGameItem = instantiate(this.addGameItemPrefab); // mainNode
        ...
        onWebViewGameLoad() {
          ...
          let webView = this.gameWebView.getChildByPath('webViewNode/WebView').getComponent(WebView); // webView.url = this.owner.gameData.GAME_URL + gameName;
        ...
        onGameRemove(gameName) {
          ...
          this.myGameContent.children.forEach((node, index) => {
            let lblGameName = node.getChildByPath('mainNode/gameInfoNode1/gameInfo/lblGameName/Label').getComponent(Label); // console.log(lblGameName.name);
        ...
        showGameRemovePopup(gameName) {
          let removeGameRemovePopup = instantiate(this.gameRemovePopupPrefab); // should_hide_in_hierarchy/fabGameRemove/gameRemoveNode/bgGameRemove/removeGameName/lblRemoveGameName
        ...
        showGameAddPopup(gameName) {
          ...
          let gameAddPopup = instantiate(this.gameAddPopupPrefab); // should_hide_in_hierarchy/fabGameAdd/gameAddNode/bgGameAdd/addGameName/lblAddGameName
        ...
        showWatchVideoPopup(coinSize, type) {
          // ============================================================================================================================
          let watchVideoPopup = instantiate(this.watchVideoPopupPrefab); // should_hide_in_hierarchy/fabWatchVideo/watchVideoNode/bgWatchVideo/watchVideoName/lblWatchVideoName
        ...
        popupDailyPromotion() {
          let dailyPromotion = instantiate(this.dailyPromotionPrefab); // should_hide_in_hierarchy/fabDailyPromotion/dailyPromotionNode/bgDailyPromotion/gameTitleNode/lblGameName
        ...
        showMessagePopup(title, msg) {
          let messageBox = instantiate(this.messageBoxPrefab); // should_hide_in_hierarchy/fabMessageBox/messageBoxNode/bgMessageBox/messageBoxTitle/lblMessageBoxTitle
